...
var NATIVE_WEAK_MAP = __webpack_require__(118);
var global = __webpack_require__(0);
var isObject = __webpack_require__(8);
var createNonEnumerableProperty = __webpack_require__(11);
...
var has = __webpack_require__(9);
var toIndexedObject = __webpack_require__(15);
var indexOf = __webpack_require__(29).indexOf;
var hiddenKeys = __webpack_require__(41);
...
var $ = __webpack_require__(5);
var $includes = __webpack_require__(29).includes;
var addToUnscopables = __webpack_require__(90);
var arrayMethodUsesToLength = __webpack_require__(34);
...
var createTypedArrayConstructor = __webpack_require__(146);
...
var toLength = __webpack_require__(4);
var toIndex = __webpack_require__(113);
var toOffset = __webpack_require__(115);
var toPrimitive = __webpack_require__(27);
var has = __webpack_require__(9);
var classof = __webpack_require__(49);
var isObject = __webpack_require__(8);
...
var global = __webpack_require__(0);
var ArrayBufferViewCore = __webpack_require__(1);
var ArrayIterators = __webpack_require__(20);
var wellKnownSymbol = __webpack_require__(3);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "toFormData", function() { return /* reexport */ lib_toFormData; });
__webpack_require__.d(__webpack_exports__, "cookie", function() { return /* reexport */ cookie; });
__webpack_require__.d(__webpack_exports__, "toLocaleString", function() { return /* reexport */ toLocaleString; });
__webpack_require__.d(__webpack_exports__, "compressImg", function() { return /* reexport */ compressImg; });
__webpack_require__.d(__webpack_exports__, "fileHandler", function() { return /* reexport */ common_fileHandler; });
...
var es_array_is_array = __webpack_require__(66);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.iterator.js
var es_array_iterator = __webpack_require__(20);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.date.to-string.js
var es_date_to_string = __webpack_require__(48);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.entries.js
var es_object_entries = __webpack_require__(93);
...
var web_dom_collections_for_each = __webpack_require__(52);
...
// CONCATENATED MODULE: ./src/common/typeofObject.ts
...
/* harmony default export */ var common_typeofObject = (typeofObject);
// CONCATENATED MODULE: ./src/lib/toFormData/resetArray.ts
...
function resetArray(formData, array, keyname) {
  // 遍歷數組
  array.forEach(function (item, index) {
    // 記錄 鍵值 以及 鍵名
    var key = "".concat(keyname, "[").concat(index, "]");
    var value = item; // 如果數組元素爲 對象 且 非數組, 則調用 對象的 處理方式, 否則, 若爲 數組, 則 遞歸調用

    if (common_typeofObject(value) === 'object') {
      toFormData_resetObject(formData, value, key);
      return false;
    } else if (common_typeofObject(value) === 'array') {
...
/* harmony default export */ var toFormData_resetArray = (resetArray);
// CONCATENATED MODULE: ./src/lib/toFormData/resetObject.ts
...
function resetObject(formData, obj, keyname) {
  // 解構出 obj 所有的 鍵值對, 並遍歷
  Object.entries(obj).forEach(function (_ref) {
    ...
    var formKey = "".concat(keyname, "[").concat(key, "]"); // 如果數據 為 object, 且 非數組 非 File 對象, 則調用 對象 處理函數, 否則 ,調用 數組處理函數

    if (common_typeofObject(value) === 'object') {
      resetObject(formData, value, formKey);
      return false;
    } else if (common_typeofObject(value) === 'array') {
      toFormData_resetArray(formData, value, formKey);
      return false;
    } // 判斷 formData 的 數據類型
...
/* harmony default export */ var toFormData_resetObject = (resetObject);
// CONCATENATED MODULE: ./src/lib/toFormData/index.ts
...
function toFormData_slicedToArray(arr, i) { return toFormData_arrayWithHoles(arr) || toFormData_iterableToArrayLimit(arr, i) || toFormData_nonIterableRest(); }

function toFormData_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function toFormData_iterableToArrayLimit(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function toFormData_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function toFormData() {
  ...
  var formData = new FormData(); // 將 JSON 拆解爲 [key, value] 組成的 二維數組, 並遍歷

  Object.entries(data).forEach(function (_ref) {
    var _ref2 = toFormData_slicedToArray(_ref, 2),
        key = _ref2[0],
        value = _ref2[1];
    ...
    if (common_typeofObject(value) === 'object') {
      ...
      toFormData_resetArray(formData, value, key);
      return false;
    }
...
toFormData.wx = function () {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  // 創建 FormData 表單數據類型
  var formatted = {}; // 遍歷 json 數據, 添加到 formatted 中

  Object.entries(data).forEach(function (_ref3) {
    var _ref4 = toFormData_slicedToArray(_ref3, 2),
        key = _ref4[0],
        value = _ref4[1];

    // 如果 數據 為 對象, 且 非 數組, 則調用 對象 處理函數, 否則 ,調用 數組處理函數
    if (common_typeofObject(value) === 'object') {
      toFormData_resetObject(formatted, value, key);
      return false;
    } else if (common_typeofObject(value) === 'array') {
      toFormData_resetArray(formatted, value, key);
      return false;
    }
...
/* harmony default export */ var lib_toFormData = (toFormData);
// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.map.js
var es_array_map = __webpack_require__(128);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.define-property.js
var es_object_define_property = __webpack_require__(98);
...
// CONCATENATED MODULE: ./src/common/splitOnce.ts
 ...
 *  - 例: 部分 cookie 的值中存在 '='
 */
function splitOnce(target, separator) {
  // 獲取 切割標記 在 target 字符串中, 首次出現的 索引
  var separatorIndex = target.indexOf(separator);
  if (separatorIndex === -1) return [];
  var first = target.substring(0, separatorIndex);
  var last = target.substring(separatorIndex + 1);
  return [first, last];
}

/* harmony default export */ var common_splitOnce = (splitOnce);
// CONCATENATED MODULE: ./src/lib/cookie/index.ts
...
function cookie_slicedToArray(arr, i) { return cookie_arrayWithHoles(arr) || cookie_iterableToArrayLimit(arr, i) || cookie_nonIterableRest(); }

function cookie_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function cookie_iterableToArrayLimit(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
(function (TimeUnit) {
  TimeUnit[TimeUnit["day"] = 1440] = "day";
  TimeUnit[TimeUnit["hour"] = 60] = "hour";
...
var cookie_Cookie = /*#__PURE__*/function () {
  function Cookie() {
    ...
    this.units = TimeUnit; // 設置 set 方法, 傳入的 deadline 參數, 的單位, 默認爲 天

    this.timeUnit = this.units.day;
  }
  /**
   * 設置 cookie 的 方法
  ...
  _createClass(Cookie, [{
    ...
    value: function set(key, value) {
      var deadline = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
      var path = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '/';
      // 計算 cookie 期限時間
      deadline = this.timeUnit * deadline * 60 * 1000; // 當 key-value 都存在時
      ...
      if (key && value) {
        ...
        document.cookie = "".concat(key, "=").concat(value, ";expires=").concat(expdate.toUTCString(), ";path=").concat(path);
      } else {
    ...
    value: function get(key) {
      var arr;
      var reg = new RegExp("(^| )".concat(key, "=([^;]*)(;|$)")); // 匹配字段
    ...
    value: function _delete(key) {
      if (key) {
        // 设置名称为name,值为value的Cookie
        var expdate = new Date('1970'); // 設置時間爲 1970

        document.cookie = "".concat(key, "=;expires=").concat(expdate.toUTCString(), ";path=/");
      } else {
    ...
    value: function getAll() {
      ...
      cookieList = cookieList.map(function (str) {
        return str.replace(/\s*/g, "");
      });
      cookieList.forEach(function (item) {
        var _splitOnce = common_splitOnce(item, '='),
            _splitOnce2 = cookie_slicedToArray(_splitOnce, 2),
            key = _splitOnce2[0],
            value = _splitOnce2[1];
...
/* harmony default export */ var cookie = (new cookie_Cookie());
// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.includes.js
var es_array_includes = __webpack_require__(131);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.includes.js
var es_string_includes = __webpack_require__(132);

// CONCATENATED MODULE: ./src/lib/toLocaleString/compatible.ts
 ...
 */
/* harmony default export */ var compatible = (function (str) {
  return str.replace(/-/g, '/');
});
// CONCATENATED MODULE: ./src/lib/toLocaleString/zeroPadding.ts
/**
 * 不滿10數字補零函數
 * @param str
 */
/* harmony default export */ var zeroPadding = (function (str) {
  return str.length < 2 ? "0".concat(str) : str;
});
// CONCATENATED MODULE: ./src/lib/toLocaleString/index.ts
...
/* harmony default export */ var toLocaleString = (function (t) {
  var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'YYYY-MM-DD hh:mm:ss';
  var zeroPad = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  ...
  var time = new Date(t); // 根據傳遞的時間 提取 年月日時分秒 數據
  ...
  var second = time.getSeconds().toString(); // 數字補零, 默認補零
  ...
  var formatList = ['YYYY', 'MM', 'DD', 'hh', 'mm', 'ss'];
  var timeList = [year, mounth, date, hours, minutes, second]; // 遍歷 formatList, 將對應規則, 一一轉化

  formatList.forEach(function (item, i) {
...
var es_promise = __webpack_require__(103);

// EXTERNAL MODULE: ./node_modules/regenerator-runtime/runtime.js
var runtime = __webpack_require__(142);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array-buffer.slice.js
var es_array_buffer_slice = __webpack_require__(143);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.uint8-array.js
var es_typed_array_uint8_array = __webpack_require__(145);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.copy-within.js
var es_typed_array_copy_within = __webpack_require__(150);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.every.js
var es_typed_array_every = __webpack_require__(152);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.fill.js
var es_typed_array_fill = __webpack_require__(153);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.filter.js
var es_typed_array_filter = __webpack_require__(154);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.find.js
var es_typed_array_find = __webpack_require__(155);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.find-index.js
var es_typed_array_find_index = __webpack_require__(156);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.for-each.js
var es_typed_array_for_each = __webpack_require__(157);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.includes.js
var es_typed_array_includes = __webpack_require__(158);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.index-of.js
var es_typed_array_index_of = __webpack_require__(159);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.iterator.js
var es_typed_array_iterator = __webpack_require__(160);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.join.js
var es_typed_array_join = __webpack_require__(161);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.last-index-of.js
var es_typed_array_last_index_of = __webpack_require__(162);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.map.js
var es_typed_array_map = __webpack_require__(164);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.reduce.js
var es_typed_array_reduce = __webpack_require__(165);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.reduce-right.js
var es_typed_array_reduce_right = __webpack_require__(166);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.reverse.js
var es_typed_array_reverse = __webpack_require__(167);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.set.js
var es_typed_array_set = __webpack_require__(168);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.slice.js
var es_typed_array_slice = __webpack_require__(169);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.some.js
var es_typed_array_some = __webpack_require__(170);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.sort.js
var es_typed_array_sort = __webpack_require__(171);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.subarray.js
var es_typed_array_subarray = __webpack_require__(172);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.to-locale-string.js
var es_typed_array_to_locale_string = __webpack_require__(173);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.typed-array.to-string.js
var es_typed_array_to_string = __webpack_require__(174);

// CONCATENATED MODULE: ./src/common/fileHandler.ts
...
// CONCATENATED MODULE: ./src/lib/compressImg/index.ts
...
/* harmony default export */ var compressImg = (function (args, callback) {
  /* global Image */
  // 提取 參數
  var _ref = args || {},
      ...
      quality = _ref$quality === void 0 ? 0.1 : _ref$quality; // 判斷主要參數是否爲空
  ...
  var fileHandler = new FileHandler(); // 主邏輯函數
  ...
  function _main() {
    _main = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(response) {
      var result, img;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", console.error('src 與 file 參數 不可都爲空'));
            ...
            case 3:
              ...
              _context.next = 6;
              return fileHandler.fileToBase64(file);
            ...
            case 8:
              ...
              img.onload = function () {
                ...
                ctx.drawImage(img, 0, 0, img.width, img.height); // 進行壓縮, 獲取 base64

                var base64 = canvas.toDataURL('image/jpeg', quality); // 將 base64 轉爲 文件

                var file = fileHandler.base64ToFile(base64, fileName); // 響應結果
...
var common_fileHandler = new FileHandler();

// CONCATENATED MODULE: ./src/test/index.test.ts
/* harmony default export */ var index_test = (function () {// testToFormData()
  // testCookies()
  // testToLocaleString()
  // testCompressImg()
});
